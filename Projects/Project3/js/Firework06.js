//This script handles the visual shape that will be drawn for the Taiko Drum sound

class Firework06 extends Base {
  ...
  constructor(x,y,minSize,maxSize,velocityx,velocityy) {
    super(x,y,random(minSize,maxSize),'#D12760');
  ...
  move() {
    ...
    this.velocityx = random(0,firework06Array.maxSpeed);
    this.velocityy = random(10,firework06Array.maxSpeed);
  }
